...
GOOGLE_OAUTH2_CLIENT_CONFIG = {
    'web': {
        'client_id': os.getenv('GOOGLE_CLIENT_ID', '507214707983-ubsf2ev7qkbcre4j4icsm8hvbq7id31a.apps.googleusercontent.com'),
        'project_id': 'linkly-458619',
        'auth_uri': 'https://accounts.google.com/o/oauth2/auth',
        'token_uri': 'https://oauth2.googleapis.com/token',
        'auth_provider_x509_cert_url': 'https://www.googleapis.com/oauth2/v1/certs',
        'client_secret': os.getenv('GOOGLE_CLIENT_SECRET', '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'),
...
GOOGLE_ADS_DEVELOPER_TOKEN = os.getenv('GOOGLE_ADS_DEVELOPER_TOKEN', '')  # Required: Get this from Google Ads API Center
GOOGLE_ADS_LOGIN_CUSTOMER_ID = os.getenv('GOOGLE_ADS_LOGIN_CUSTOMER_ID', '')  # Optional: Manager account ID

# Google Ads OAuth2 Scopes
GOOGLE_ADS_SCOPES = [
