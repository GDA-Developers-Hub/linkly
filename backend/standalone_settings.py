"""
Standalone Django settings for deployment.
This file contains all necessary settings without requiring imports from other modules.
"""
...
INSTALLED_APPS = [
    ...
    # Local apps - uncomment as you create these
    'users',
    'subscriptions',
    'content',
    'platforms',
...
# Add additional static file settings for whitenoise
WHITENOISE_USE_FINDERS = True
WHITENOISE_MANIFEST_STRICT = False
WHITENOISE_ALLOW_ALL_ORIGINS = True

# Enable debug_toolbar in debug mode
if DEBUG:
